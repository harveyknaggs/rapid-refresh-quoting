...
const SYSTEM = [
  ...
  '- Delivery: if bulk material needs carting, add a separate "other" line, pricing {"method":"passthrough"},',
  '  using the price-book "Delivery / cartage" cost per load. Bark trailer 2 m3/load; AP20/aggregate ≈ 0.667 m3/load.',
